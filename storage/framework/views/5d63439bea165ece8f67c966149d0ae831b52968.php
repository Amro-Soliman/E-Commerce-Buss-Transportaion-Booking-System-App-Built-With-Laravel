...
<head>
        ...
        <link rel="stylesheet" href="<?php echo e(URL::asset('css/styles\themes\style10\stylesheet10.css')); ?>" />
                <?php echo toastr_css(); ?>
        ...
        <script src="<?php echo e(URL::asset('inc/js/styleswitch.js')); ?>" type="text/javascript">
...
***********************************************/
        ...
        <link rel="stylesheet" href="<?php echo e(URL::asset('css/styles/flexslider.css')); ?>" />



        <!-- fontawesome -->

        <link rel="stylesheet" href="<?php echo e(URL::asset('css/styles/fontawesome/font-awesome.min.css')); ?>" />



        <!-- Datepicker UI -->

        <link rel="stylesheet" href="<?php echo e(URL::asset('css/styles/jquery-ui-1.10.3.custom.min.css')); ?>" />



        <!-- MI slider -->

        <link rel="stylesheet" href="<?php echo e(URL::asset('css/styles/mi-slider.css')); ?>" />	



        <!-- Chozen UI -->

        <link rel="stylesheet" href="<?php echo e(URL::asset('css/styles/chosen.css')); ?>" />	



        <!-- Range Slider UI #2 -->

        <link rel="stylesheet" href="<?php echo e(URL::asset('css/styles/rangeslider-classic.css')); ?>" />



        <!-- Elegant Font -->

        <link rel="stylesheet" href="<?php echo e(URL::asset('inc/elegant-font/style.css')); ?>" />
            ...
            <header id="header" class="wide-fat">
                    ...
                    <div class="col-xs-12 col-sm-2 no-margin">
                        ...
                        <div class="branding">
                            ...
                            <h1 class="site-title">
                                ...
                                <a href="#"><img src="<?php echo e(URL::asset('images/site-logo.png')); ?>" alt="Traveline" /> <span>Travel<span class="higlight">ine</span></span></a>
                ...
                <div class="toggle-menu-holder">
                    ...
                    <div class="menu-body closed">
                        ...
                        <ul>
                        <?php if(auth()->check()): ?>
                        <li style="text-align:center"> <p> <i class="fa fa-user"></i> <?php echo e(auth()->user()->name); ?> </p></li>
                        <?php endif; ?>
                        <?php if(auth()->guard()->guest()): ?>
                        <li><a href="<?php echo e(route('login')); ?>"><i class="fa fa-user"></i> login</a></li>
                            
                            <li><a href="<?php echo e(route('register')); ?>"><i class="fa fa-user"></i> register</a></li>
                        <?php else: ?>
                        <li><a href="<?php echo e(route('logout')); ?>"><i class="fa fa-user"></i> logout</a></li>
                        <?php endif; ?>
...
<input class="custom-checkbox" type="checkbox" type="checkbox" name="remember" id="remember" <?php echo e(old('remember') ? 'checked' : ''); ?> >
...
<span>Remember me on this computer.</span>
       ...
       <div>
       <?php echo $__env->yieldContent('journeyResult'); ?>
       </div>
...
<div class="container">
    ...
    <script src="<?php echo e(URL::asset('inc/js/jquery-1.10.2.min.js')); ?>"></script>

    <script src="<?php echo e(URL::asset('inc/js/jquery-migrate-1.2.1.js')); ?>"></script>
    ...
    <script src="<?php echo e(URL::asset('inc/js/modernizr.custom.63321.js')); ?>"></script>



    <!-- FlexSlider -->

    <script type="text/javascript" src="<?php echo e(URL::asset('inc/js/jquery.flexslider-min.js')); ?>"></script>	
    ...
    <script type="text/javascript" src="<?php echo e(URL::asset('inc/js/jquery.catslider.js')); ?>"></script>	
    ...
    <script type="text/javascript" src="<?php echo e(URL::asset('inc/js/jquery.ui.datepicker.min.js')); ?>"></script>	
    ...
    <script type="text/javascript" src="<?php echo e(URL::asset('inc/js/masonry.min.js')); ?>"></script>	
    ...
    <script type="text/javascript" src="<?php echo e(URL::asset('inc/js/increase-decrease-qty.js')); ?>"></script>	



    <!-- Mixitup (filterable item) -->

    <script type="text/javascript" src="<?php echo e(URL::asset('inc/js/jquery.mixitup.min.js')); ?>"></script>	
    ...
    <script type="text/javascript" src="<?php echo e(URL::asset('inc/js/google-map-infobox.js')); ?>"></script>		
    ...
    <script type="text/javascript" src="<?php echo e(URL::asset('inc/js/jquery.fitmaps.js')); ?>"></script>	



    <!-- Chozen UI JS -->

    <script type="text/javascript" src="<?php echo e(URL::asset('inc/js/chosen.jquery.js')); ?>"></script>	
    ...
    <script type="text/javascript" src="<?php echo e(URL::asset('inc/js/jquery.screwdefaultbuttonsV2.js')); ?>"></script>	
    ...
    <script type="text/javascript" src="<?php echo e(URL::asset('inc/js/jquery.mousewheel.min.js')); ?>"></script>	

    <script type="text/javascript" src="<?php echo e(URL::asset('inc/js/jQRangeSlider-min.js')); ?>"></script>	

    <!-- bootstrap JS -->

    <script type="text/javascript" src="<?php echo e(URL::asset('inc/bootstrap/js/bootstrap.min.js')); ?>"></script>		

    <!-- raty JS -->

        <script type="text/javascript" src="<?php echo e(URL::asset('inc/js/jquery.raty.min.js')); ?>"></script>	

    <!-- Custom JS -->

    <script type="text/javascript" src="<?php echo e(URL::asset('inc/js/custom.js')); ?>"></script>	
...
<?php /**PATH C:\xampp\htdocs\BuzzSystem\resources\views/layouts/app.blade.php ENDPATH**/ ?>